...
// New elements for the theme and strength text
...
let checkCount = 0;
handleSlider();
//set strength circle color and text
setIndicator("#ccc", "");
...
function setIndicator(color, strengthLabel) {
...
function toggleTheme() {
    ...
    themeSwitchBtn.innerText = isLightTheme ? '☀️' : '🌙'; // Change text/emoji on button
}
